  ...
  return (
    <div className="hero min-h-[700px]">
      <div className="hero-content flex-col lg:flex-row">
        ...
        <div className="card flex-shrink-0 w-full max-w-sm shadow-xl bg-[#B1CEFB]">
          <div className="card-body">
            ...
            <form onSubmit={handleLogIn}>
              ...
              <div className="form-control mt-6 mb-3">
                <input type="submit" value='Log In' className='btn btn-secondary capitalize' />
              </div>
              {
              ...
              <div className='text-center space-y-4'>
                <div className='text-xl text-[#171717]'>
                  Or login with
                </div>
                <div>
                  <button
              ...
              <div className='text-lg'>
                New to this site. <Link to='/registration' className='text-red-500 underline'>Sign Up</Link> now.
              </div>
            </form>
